...
import TableRowHasChild2 from "./tableRowHasChild2";

function TableRowHasChild1(props) {
  const a = props.a;
  ...
  for (const i in hide) {
    if (hide[i].object_name == props.data[2]) {
      for (const sub_arg in hide[i]["Arguments"][props.level_1_parent][
        a.Argument_Name
      ]) {
        hideStatus[sub_arg] =
          hide[i]["Arguments"][props.level_1_parent][a.Argument_Name][sub_arg];
      }
    }
  }
        ...
        if (!Object.keys(props.children_of_child).includes(b.Argument_Name)) {
          content.push(
            <tr>
              ...
              {b.Argument_Optional == "False" && (
                <td className="level-2-child">
                  &#8226; {` ${b.Argument_Name} *`}
                </td>
              )}
              {b.Argument_Optional != "False" && (
              ...
              {hideStatus[b.Argument_Name] && (
                <td>
                  <input
                    ...
                    onClick={() => {
                      dispatch(
                        actions.addHideSubChildValue([
                          props.data[1],
                          props.data[2],
                          a.Argument_Name,
                          b.Argument_Name,
                          props.level_1_parent,
                        ])
                      );
                    }}
                    checked
              ...
              {
                <td>
                  <TableColumnSubChildData
                    id={props.data[1]}
                    obj={props.data[2]}
                    level_1_parent={props.level_1_parent}
...
export default TableRowHasChild1;
